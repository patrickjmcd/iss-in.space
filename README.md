...
**[https://iss.guru](https://iss.guru)** - A modern web interface and API serving accurate ISS pass predictions for both visual observation and amateur radio use.
...
```bash
docker pull ghcr.io/patrickjmcd/iss.guru:latest
docker run -p 8000:8000 ghcr.io/patrickjmcd/iss.guru:latest
```
...
docker run -p 8000:8000 \
  ...
  ghcr.io/patrickjmcd/iss.guru:latest
```
...
Releases are managed by [release-please](https://github.com/googleapis/release-please). Merging a release PR to `master` creates a GitHub release and triggers a Docker image build tagged with the semver version and pushed to `ghcr.io/patrickjmcd/iss.guru`.
